  ...
  if($gambar_buku != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, 'gambar/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE tabelbuku SET judul = '$judul', pengarang = '$pengarang', penerbit = '$penerbit',  gambar_buku = '$nama_gambar_baru'";
      ...
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      $query  = "UPDATE tabelbuku SET judul = '$judul', pengarang = '$pengarang', penerbit = '$penerbit'";
      $query .= "WHERE id_buku = '$id_buku'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
